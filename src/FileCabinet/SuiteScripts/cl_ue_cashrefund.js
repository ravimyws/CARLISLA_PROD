        ...
        const afterSubmit = (scriptContext) => {
            ...
            try {
                ...
                if (scriptContext.type === scriptContext.UserEventType.CREATE || scriptContext.type === scriptContext.UserEventType.EDIT) {
                    ...
                    let returnAuthorization = getRecord(record.Type.RETURN_AUTHORIZATION, createdFrom,false);

                    let cashSaleOrInvoice = getRecord(record.Type.CASH_SALE, createdFrom,false) || getRecord(record.Type.INVOICE, createdFrom,false);
                    //write logic here
                    if(!(returnAuthorization || cashSaleOrInvoice)){
                        log.error('Reason',`Cash Refund is not created by Cash Sale or Return Authorization`);
                        return;
                    }
                    ...
                    if (salesOrderType) {
                        ...
                        if (isAgency) {
                            ...
                            if (!salesOrderCommission && (associateCommission > primaryCommission)) {
                        ...
                        if (isAgency) {
                            ...
                            if(!associateCommission){
                                ...
                                let vbid = createVC(transactionObj.id, salesOrderCommission, associate, brand,seasonIop);
                                savedVBS.push(vbid);
                            }
